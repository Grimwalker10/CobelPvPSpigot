...
public class AnticheatEvent extends PlayerEvent {
    ...
    public AnticheatEvent(Player player, Cheat cheat, String module, DisplayLevel level, String message) {
        super(player);
    ...
    public AnticheatEvent(Player player, Cheat cheat, String module, DisplayLevel level, String message, Location location) {
        super(player);
    ...
    public AnticheatEvent addData(String key, Object value) {
        data.put(key, value);
        return this;
    }
    ...
    public enum DisplayLevel {
        ...
        public boolean willDisplay(Player player) {
            return player.hasPermission("anticheat.display." + name().toLowerCase());
        }
