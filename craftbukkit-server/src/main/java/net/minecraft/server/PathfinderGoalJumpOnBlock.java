...
public class PathfinderGoalJumpOnBlock extends PathfinderGoal {
    ...
    public void c() {
        this.a.getNavigation().a(com.cobelpvp.pathsearch.PositionPathSearchType.JUMPONBLOCK, (double) ((float) this.f) + 0.5D, (double) (this.g + 1), (double) ((float) this.h) + 0.5D, this.b); // Poweruser
        this.c = 0;
        this.d = 0;
