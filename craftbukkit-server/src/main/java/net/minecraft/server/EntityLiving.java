...
public abstract class EntityLiving extends Entity {
    ...
    public void C() {
        SpigotTimings.timerEntityLiving_C.startTiming(); // CobelPvP
        this.aC = this.aD;
        super.C();
        ...
        SpigotTimings.timerEntityLiving_C.stopTiming(); // CobelPvP
    }
    ...
    public EntityLiving aX() {
        return (EntityLiving) (this.combatTracker.c() != null ? this.combatTracker.c() : (this.killer != null ? this.killer : (this.lastDamager)));
    }
